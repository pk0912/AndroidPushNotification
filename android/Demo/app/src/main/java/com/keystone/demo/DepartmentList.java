...
public class DepartmentList extends AppCompatActivity {
    ...
    private void getData() {
        ...
        data[0]=url;
        new GetDeptAsync(DepartmentList.this).execute(data);
    }
            ...
            public void onClick(View v) {
              /*  StringBuffer responseText = new StringBuffer();
                ...
                if(message==null)
                {
                    ...
                    message=usermessage;
                    String url = "http://pkredroses.tk/Demo/rest/DepartmentNotify";
                    NotificationPost notificationasync = new NotificationPost(DepartmentList.this);

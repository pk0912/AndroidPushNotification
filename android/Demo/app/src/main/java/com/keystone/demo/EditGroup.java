...
public class EditGroup extends AppCompatActivity {
    ...
    private void getData() {
        ...
        data[0] = url;
        new AdminConfigAsync1(EditGroup.this).execute(data);
    }
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                Uri.parse("android-app://com.keystone.demo/http/host/path")
        );
    ...
    public class AdminConfigAsync extends AsyncTask<String, Void, ArrayList<DeptVO>> {
        ...
        protected void onPostExecute(ArrayList<DeptVO> eL) {
            ...
            if (deptListVO != null) {
                f = 1;
                System.out.println("dept:" + deptListVO.getDeptlist() + "::::::::::Emp:" + deptListVO.getEmplist());
    ...
    public class AdminConfigAsync1 extends AsyncTask<String, Void, ArrayList<GroupVO>> {
        ...
        protected void onPostExecute(ArrayList<GroupVO> eL) {
            ...
            if (groupListVO != null) {
                ...
                Intent i = getIntent();
                oldgroup = i.getStringExtra("grpname");
                System.out.println("Edit group:" + oldgroup);
                name.setText(oldgroup);
                String url = Config.APP_SERVER_URL + "AdminConfigWebService/getDeptList/" + oldgroup;
                String[] data = new String[1];
                data[0] = url;
                new AdminConfigAsync(EditGroup.this).execute(data);
            }
            if (f == 0) {
                Toast.makeText(activity, "oops!!! Something went wrong at server side", Toast.LENGTH_LONG).show();
                // return subjectsList;
        ...
        fb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              /*  StringBuffer responseText = new StringBuffer();
                ...
                name = (EditText) findViewById(R.id.eGName);
                newgroup = name.getText().toString();

                String url = Config.APP_SERVER_URL + "AdminConfigWebService/updategroup";
                StatusAsync st = new StatusAsync(StatusAsync.POST_TASK, EditGroup.this, newgroup);
                st.addNameValuePair("oldgroup", oldgroup);
                st.addNameValuePair("newgroup", newgroup);
